...
rdir1 <- '/home-4/whou10@jhu.edu/work-zfs/whou10/metpred/simu/perf/sensfdr_cutoff1/'
rdir2 <- '/home-4/whou10@jhu.edu/work-zfs/whou10/metpred/simu/perf/perf_cutoff1/'
...
saveRDS(pd1, paste0(pddir, 'perf_fdrdiff_cutoff1.rds')) ######### caution
saveRDS(pd2, paste0(pddir, 'perf_auc_cutoff1.rds')) ######### caution
