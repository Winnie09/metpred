...
pred = readRDS('/home/whou10/data/whou/metpred/evaluate/pbmc/imp/res/pred/pred_top1e4_mono_t_diff_greater0.2_tr_te.rds')
...
png('/home/whou10/data/whou/metpred/evaluate/pbmc/plot/acrosscpg_pcc_diffcpg.png',res = 300,
    width = 650, height = 650)
