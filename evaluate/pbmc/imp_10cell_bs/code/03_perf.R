...
pred = readRDS('/home/whou10/data/whou/metpred/evaluate/pbmc/imp_10cell_bs/res/pred/pred_top1e4_mono_t_diff_greater0.2_tr_te.rds')
...
saveRDS(pd, '/home/whou10/data/whou/metpred/evaluate/pbmc/imp_10cell_bs/perf/acrosssample_pcc.rds')

png('/home/whou10/data/whou/metpred/evaluate/pbmc/imp_10cell_bs/plot/acrosssample_pcc.png',res = 300,
...
saveRDS(pd2, '/home/whou10/data/whou/metpred/evaluate/pbmc/imp_10cell_bs/perf/acrosscpg_pcc.rds')

png('/home/whou10/data/whou/metpred/evaluate/pbmc/imp_10cell_bs/plot/acrosscpg_pcc.png',res = 300,
    width = 650, height = 650)
