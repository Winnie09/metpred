...
d <- sapply(1:sid,function(i) {
  d <- readRDS(paste0('/home/whou10/data/whou/metpred/evaluate/encode_cv/binpred/',type,'/',i,'.rds'))
...
saveRDS(sample,file=paste0('/home/whou10/data/whou/metpred/evaluate/encode_cv/binperf/',type,'/sample.rds'))
saveRDS(cpg,file=paste0('/home/whou10/data/whou/metpred/evaluate/encode_cv/binperf/',type,'/cpg.rds'))
...
saveRDS(difcor,file=paste0('/home/whou10/data/whou/metpred/evaluate/encode_cv/binperf/',type,'/difcor.rds'))
