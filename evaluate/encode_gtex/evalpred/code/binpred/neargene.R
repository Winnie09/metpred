...
pred <- nearestgenepredict(trainexpr=ge,testexpr=predge,trainmeth=me)
saveRDS(pred,file='/home/whou10/data/whou/metpred/evaluate/encode_gtex/binpred/neargene.rds')
