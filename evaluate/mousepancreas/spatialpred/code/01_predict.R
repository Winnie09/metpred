...
saveRDS(prome, paste0('/home/whou10/data/whou/metpred/evaluate/mousepancreas/spatialpred/gs/', test.s, '.rds'))
...
str(cpg.id)
length(unique(o[,2]))
saveRDS(data.frame(cpg = rownames(w)[o[,1]], gene = names(pro)[o[,2]]), 'spatialpred/genecpg/gene_cpg_leaveout1k.rds')
...
saveRDS(pred, paste0('spatialpred/res/pred_', test.s, '.rds'))
