...
seed <- as.numeric(commandArgs(trailingOnly = T)[5]) ## 1:100
# nSample = 2
# nCell = 2
# propCpG = 0.2
# probRead= 0.3
rdir <- paste0('/home-4/whou10@jhu.edu/work-zfs/whou10/metpred/simuseed/res/', seed,'/', nSample, '_', nCell, '_', propCpG, '_', probRead, '/')
print(rdir)
...
source('/home-4/whou10@jhu.edu/work-zfs/whou10/raisin/software/raisin/raisin.R')
