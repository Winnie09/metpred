...
saveRDS(v,file='/home/whou10/data/whou/metpred/data/tcga/hg38/2024/array/pos/450k.rds')
df = data.frame(CpG_name = names(v), CpG_location = unname(v), stringsAsFactors = F)
write.csv(df,'/home/whou10/data/whou/metpred/data/tcga/hg38/2024/array/pos/450k.csv', row.names = F, quote = F)
