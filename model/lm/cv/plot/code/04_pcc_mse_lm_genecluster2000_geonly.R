...
allf = list.files('/home-4/zji4@jhu.edu/scratch/metpred/model/lm/cv/res/lm_genecluster2000_geonly/')
pl <- pl2 <- list()
for (f in allf){
  load(paste0('/home-4/zji4@jhu.edu/scratch/metpred/model/lm/cv/res/lm_genecluster2000_geonly/',f))
...
saveRDS(list(pd=pd, pd2=pd2),'/home-4/whou10@jhu.edu/scratch/Wenpin/metpred/model/lm/cv/plot/lm_genecluster2000_geonly/pcc_mse_pd.rds')

ggsave('/home-4/whou10@jhu.edu/scratch/Wenpin/metpred/model/lm/cv/plot/lm_genecluster2000_geonly/pcc_mse.png',
