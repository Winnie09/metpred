...
saveRDS(list(pd=pd, pd2=pd2),'/home-4/whou10@jhu.edu/scratch/Wenpin/metpred/model/lm/cv/plot/lm_genecluster1000_geonly/pcc_mse_pd.rds')

ggsave('/home-4/whou10@jhu.edu/scratch/Wenpin/metpred/model/lm/cv/plot/lm_genecluster1000_geonly/pcc_mse.png',
