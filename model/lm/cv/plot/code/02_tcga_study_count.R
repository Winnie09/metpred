...
dir.create('/home-4/whou10@jhu.edu/scratch/Wenpin/metpred/model/lm/cv/plot/stat/')
pdf('/home-4/whou10@jhu.edu/scratch/Wenpin/metpred/model/lm/cv/plot/stat/study_abbreviation_barplot.pdf',width=8,height=5)
