allf <- list.files('/home-4/whou10@jhu.edu/scratch/Wenpin/metpred/model/lm/diff/limma/tmpres/')
f <- allf[1]
cc <- sapply(allf, function(f){
  tmp <- readRDS(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/metpred/model/lm/diff/limma/tmpres/',f))
  return(tmp)
})
...
pd = melt(cc)
pdf('/home-4/whou10@jhu.edu/scratch/Wenpin/metpred/model/lm/diff/limma/plot/PCC_between_measured_and_predicted_two_type_difference.pdf',width=6,height=4)
