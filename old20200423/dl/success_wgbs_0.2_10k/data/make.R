...
d <- readRDS('/home-4/zji4@jhu.edu/scratch/encode_compiled/Nov19/wgbs/hg38filtermat/mat.rds') # [1:28983007, 1:76] 
...
id <- which(rowSds(d) > 0.2) # [1:12379166] 
#id <- 1:nrow(d)
...
#}))
saveRDS(m,file='/home-4/zji4@jhu.edu/scratch/metpred/bulkcv//data/trainx.rds')
...
#  colMeans(m[names(clu)[clu==i],])
#}))
saveRDS(m,file='/home-4/zji4@jhu.edu/scratch/metpred/bulkcv//data/testx.rds')
