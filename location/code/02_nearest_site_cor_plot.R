...
# chrn = 'chr21'
df = readRDS(paste0('./metpred/location/plot/',key,'/nearest_site_cor_',chrn,'_pd.rds'))
...
pdf(paste0('./metpred/location/plot/',key,'/nearest_site_cor_',chrn,'.pdf'),width=3.8,heigh=2)
