...
mat = mat[id,]
gr = gr[id] ###
saveRDS(mat,paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/metpred/data/data/wgbs/beta_',chrn,'.rds'))
saveRDS(gr, paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/metpred/data/data/wgbs/basegr_',chrn,'.rds'))
...
df$type = factor(df$type, levels = c('two sites(dist<100bp)', 'two random sites'))
saveRDS(df,paste0('./metpred/location/plot/wgbs/nearest_site_cor_',chrn, '_pd.rds'))
